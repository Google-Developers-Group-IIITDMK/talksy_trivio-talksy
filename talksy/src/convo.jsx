...
const ChatPage = () => {
  ...
  return (
    ...
    <div
      ref={mainRef}
      className="w-full h-screen bg-[#f1f1f1] flex flex-col md:flex-row"
    >
      ...
      <div className="w-full md:w-1/2 h-1/2 md:h-full flex flex-col justify-between p-8 text-black">
        <div data-anim="fade-in" className="text-center font-black uppercase">
          ...
          <h1 className="text-6xl md:text-8xl tracking-tighter -mt-2 md:-mt-4">
            Doraemon
          </h1>
        </div>
        ...
        <div data-anim="fade-in" className="flex flex-col items-center">
          ...
          >
            ...
            {/* <div className={`moveLink absolute top-0 left-0 w-full flex bg-[#D3FD50] text-black ${recordingStatus === 'listening' ? 'translate-y-0' : 'translate-y-full'}`}>
                    <div className="moveX flex items-center whitespace-nowrap animate-moveX text-black">
            ...
            <div
              className={`moveLink absolute top-0 left-0 w-full h-full flex bg-[#D3FD50] text-black ${
                recordingStatus === "listening"
                  ? "translate-y-0"
                  : "translate-y-full"
              }`}
            >
                 <div className="flex justify-center z-30 items-center h-full gap-x-1.5 bg-amber-800">
                <span
                  className="wave-bar h-10 w-1.5 rounded-full bg-black"
          ...
          <p className="mt-4 text-gray-600 text-sm">
            {recordingStatus === "processing"
              ? "Doraemon is thinking..."
              : "Tap to start or stop the conversation"}
          </p>
        </div>
      </div>
    </div>
